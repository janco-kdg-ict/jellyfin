...
(function () {
    ...
    style.textContent = [
        ...
        "  border:2px solid color-mix(in srgb, var(--c-1,#b6ff1a) 50%, transparent);",
        "  font-family:'Trebuchet MS','Segoe UI',system-ui,sans-serif;",
        "  backdrop-filter:blur(8px);transition:border-color .3s;}",
        "#arcaneToggle:hover{border-color:var(--c-1,#b6ff1a);}",
        "#arcaneToggle .lbl{font-size:.6rem;font-weight:800;letter-spacing:.16em;padding:0 .4rem;transition:opacity .3s;}",
        "#arcaneToggle .lp{color:#5cc8f5;} #arcaneToggle .lj{color:#b6ff1a;}",
        ...
        "  transform:translateY(-50%);background:radial-gradient(circle at 35% 30%,#cfeeff,var(--c-1,#b6ff1a));",
        "  box-shadow:0 0 12px var(--glow,#b6ff1a);transition:left .4s cubic-bezier(.7,-0.4,.3,1.4);}",
